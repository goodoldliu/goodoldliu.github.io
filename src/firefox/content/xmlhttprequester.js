function goodoldliu_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
goodoldliu_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				goodoldliu_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
goodoldliu_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
goodoldliu_xmlhttpRequester.prototype.setupRequestEvent =
